...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\begin{minipage}[t]{\widthof{\Verb|/system|} + 1cm}
				\item \Verb|/boot|
				\item \Verb|/system|
			\end{minipage}
			\begin{minipage}[t]{\widthof{\Verb|/recovery|} + 1cm}
				\item \Verb|/recovery|
				\item \Verb|/data|
			\end{minipage}
			\begin{minipage}[t]{\widthof{\Verb|/cache|} + 1cm}
				\item \Verb|/cache|
				\item \Verb|/misc|
			\end{minipage}
		\end{itemize}
		...
		\begin{itemize}
			\begin{minipage}[t]{\widthof{\Verb|openFileInput()|} + 1cm}
				\item \Verb|openFileInput()|
			\end{minipage}
			\begin{minipage}[t]{\widthof{\Verb|openFileOutput()|} + 1cm}
	...
	\item SQLite
	\begin{itemize}
		\begin{minipage}[t]{\widthof{Relational database} + 1cm}
			\item Relational database
			\item Serverless
		\end{minipage}
		\begin{minipage}[t]{\widthof{Zero-configuration} + 1cm}
			\item Zero-configuration
			\item File-based
		\end{minipage}
		\begin{minipage}[t]{\widthof{Widely used} + 1cm}
			\item Widely used
		\end{minipage}
	\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\begin{minipage}[t]{\widthof{\Verb|DatabaseReference|} + 1cm}
				\item \Verb|DatabaseReference|
				\item \Verb|DataSnapshot|
			\end{minipage}
			\begin{minipage}[t]{\widthof{\Verb|ValueEventListener|} + 1cm}
